document.addEventListener('DOMContentLoaded', () => {
    ...
    function downloadReview() {
        ...
        const content = [
            '╔══════════════════════════════════════════════════════════╗',
            '║         GHOST REVIEW — ADVERSARIAL PEER REVIEW REPORT       ║',
            '╚══════════════════════════════════════════════════════════╝',
            '',
            `Date: ${timestamp}`,
            `Conference Target: ${confName}`,
            '',
            '═══════════════════════════════════════════════════════════',
            'ORIGINAL ABSTRACT',
            '═══════════════════════════════════════════════════════════',
            ...
            '',
            '───────────────────────────────────────────────────────────',
            'Generated by Ghost Review AI Specialist • Verified by SmileyAngelica',
            '───────────────────────────────────────────────────────────'
        ].join('\n');
        ...
        a.href = url;
        a.download = `GhostReview_${confName.replace(/[^a-z0-9]/gi, '_')}_${Date.now()}.txt`;
        a.click();
